...
########## Assign Variables. ##########
nav_items = ['Home', 'Blog', 'Projetos', 'Arquivo', u'História']
...
def projects():
    ...
    return render_template('simple.html', title='', content=content[0],
                           nav_items=nav_items)
...
def archive():
    ...
    return render_template('archive.html', title='Arquivo',
